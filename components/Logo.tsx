...
export const Logo: React.FC<{ className?: string }> = ({ className }) => {
  return (
    <svg 
      ...
      aria-hidden="true"
    >
      {/* Global Breathing Animation: Applies Gold Glow & Scale to the entire logo */}
      <g className="origin-center animate-pulse-slow" style={{ transformBox: 'fill-box' }}>
        ...
        <g stroke="currentColor">
          ...
          {/* Inner Core - Gold & Intense */}
          <g className="origin-center text-mystic-gold" style={{ transformBox: 'fill-box' }}>
              {/* Diamond Shape */}
